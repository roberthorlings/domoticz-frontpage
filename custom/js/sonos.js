...
Domotica.sonos = {
	...
	initialize: function() {
		...
		$(".music .music-controls .play").on("click", Domotica.sonos.change.play);
		$(".music .music-controls .pause").on("click", Domotica.sonos.change.pause);
		$(".music .music-controls .next").on("click", Domotica.sonos.change.next);
		$(".music .music-controls .prev").on("click", Domotica.sonos.change.previous);
	},
	...
	updateWidget: {
		status: function(data) {
			...
			switch(data.state.name) {
				case "PLAYING":
					...
					// Update controls
					element.find( ".music-controls .play" ).hide();
					element.find( ".music-controls .pause" ).show();
				...
				case "PAUSED_PLAYBACK":
					...
					// Update controls
					element.find( ".music-controls .play" ).show();
					element.find( ".music-controls .pause" ).hide();
		...
		updateTrack: function(element, state) {
			...
			var progress = Domotica.sonos.translate.progress(state.details.position, state.details.duration);
